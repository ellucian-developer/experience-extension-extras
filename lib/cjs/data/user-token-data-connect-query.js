...
async function userTokenDataConnectQuery({
  ...
  try {
    ...
    const accept = acceptParameter || AcceptParameter ? acceptParameter || AcceptParameter : acceptVersion ? `application/vnd.hedtech.integration.v${acceptVersion}+json` : 'application/json';
    const fetchOptions = {
...
//# sourceMappingURL=user-token-data-connect-query.js.map