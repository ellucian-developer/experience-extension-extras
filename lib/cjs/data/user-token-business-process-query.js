...
async function userTokenBusinessProcessQuery({
  ...
  try {
    ...
    const accept = acceptParameter || AcceptParameter ? acceptParameter || AcceptParameter : `application/vnd.hedtech.integration.v${acceptVersion ? acceptVersion : '1.0.0'}+json`;
...
//# sourceMappingURL=user-token-business-process-query.js.map