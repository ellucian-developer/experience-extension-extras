...
function ProviderInternal({
  ...
  const DataQueryContext = useMemo(() => {
    ...
    // create if needed
    const context = contextsByKey[key] || /*#__PURE__*/createContext({});
  ...
  return /*#__PURE__*/_jsx(DataQueryContext.Provider, {
    value: contextValue,
    children: children
  });
}
export function DataQueryProvider(props) {
  return /*#__PURE__*/_jsx(QueryClientProvider, {
    client: queryClient,
    children: /*#__PURE__*/_jsx(ProviderInternal, {
      ...props
    })
  });
}
export function MultiDataQueryProvider({
  options,
  children
}) {
  const renderProviders = optionsArray => {
    ...
    if (currentOptions) {
      return /*#__PURE__*/_jsx(DataQueryProvider, {
